...
NOTE: Rerunning the alignment will take a long time (~ 10 minutes). The only reason you should rerun alignment is if you have
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Process a ribosome instance.")
